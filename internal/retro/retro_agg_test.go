...
func (m *mockStore) InsertClassification(ctx context.Context, c *models.Classification) error {
	return nil
}
func (m *mockStore) QueryClassifications(ctx context.Context, ids []string) ([]models.Classification, error) {
	return nil, nil
}
func (m *mockStore) GetUnclassified(ctx context.Context, limit int) ([]models.PromptEvent, error) {
	return nil, nil
}
func (m *mockStore) UpsertSession(ctx context.Context, s *models.Session) error { return nil }
func (m *mockStore) QuerySessions(ctx context.Context, f store.SessionFilter) ([]models.Session, error) {
	return nil, nil
}
